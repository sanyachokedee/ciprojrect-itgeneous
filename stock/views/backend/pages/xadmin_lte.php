      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo base_url();?>assets/backend/dist/img/user1-128x128.jpg" alt="User Avatar" class="mr-3 img-size-50 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo base_url();?>assets/backend/dist/img/user8-128x128.jpg" alt="User Avatar" class="mr-3 img-size-50 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo base_url();?>assets/backend/dist/img/user3-128x128.jpg" alt="User Avatar" class="mr-3 img-size-50 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
          ...
          <section class="col-lg-7 connectedSortable">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="<?php echo base_url();?>assets/backend/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="<?php echo base_url();?>assets/backend/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url();?>assets/backend/dist/img/user1-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url();?>assets/backend/dist/img/user7-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url();?>assets/backend/dist/img/user3-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url();?>assets/backend/dist/img/user5-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url();?>assets/backend/dist/img/user6-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?php echo base_url();?>assets/backend/dist/img/user8-128x128.jpg">
            ...
            <div class="card">
              ...
              <div class="clearfix card-footer">
                <button type="button" class="float-right btn btn-info"><i class="fas fa-plus"></i> Add item</button>
              </div>
            </div>
            <!-- /.card -->
          </section>
